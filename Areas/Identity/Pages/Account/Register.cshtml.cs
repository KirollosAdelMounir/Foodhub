...
namespace FoodHub.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(255, ErrorMessage = "The first name should have at most 255 characters", MinimumLength = 3)]
            [Display(Name = "First Name")]
            public string FirstName { get; set; }

            [Required]
            [StringLength(255, ErrorMessage = "The last name should have at most 255 characters", MinimumLength = 3)]
